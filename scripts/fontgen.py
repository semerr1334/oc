...
CELL_W, CELL_H = 8, 16
BASELINE = 12          # y базовой линии в ячейке

def glyph_rows(ch: str):
    """Возвращает список из 16 байт (бит 7 = левый пиксель)."""
    img = Image.new("L", (CELL_W * 4, CELL_H * 4), 0)  # суперсемплинг x4
    d = ImageDraw.Draw(img)
    font = ImageFont.truetype(FONT_PATH, 11)           # 11px в кегле 16
    d.text((2, 2), ch, fill=255, font=font, anchor="la")
