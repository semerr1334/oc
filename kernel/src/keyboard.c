...
static const u16 map_ru[2][64] = {
    ...
    { /* shift */
        ...
        0x412,0x410,0x41F,0x420,0x41E,0x41B,0x414,0x416,0x42D, 0x401, 0, '/', 0x42F,0x427,0x421,0x41C,
...
static void handle_scancode(u8 sc)
{
    ...
    /* модификаторы */
    if (code == 0x2A || code == 0x36) { shift = !release; e0_prefix = false; return; }
    if (code == 0x1D) { ctrl = !release; e0_prefix = false; return; }
    if (code == 0x38) { alt = !release; e0_prefix = false; return; }
